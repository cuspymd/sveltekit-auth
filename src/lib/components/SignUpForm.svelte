...
<form on:submit|preventDefault={submit} class='space-y-5 {$$props.class}'>
    ...
    <Input label='Confirm Password' id='confirm-password' name='confirm-password' type='password' bind:value={confirmPassword} bind:inputRef={confirmPasswordInputRef} required />
    {#if error}
